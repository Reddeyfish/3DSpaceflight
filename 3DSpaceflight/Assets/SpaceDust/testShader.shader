Shader "Foliage/Leaves(Wind.Transulence.Fresnel)" {
    Properties {
...
void surf (Input IN, inout SurfaceOutput o) {
    ...
    //fixed colorLevel = (difference2 * (_TopColor.rgb *2)  + (1-difference2));
    o.Albedo = fixed3(difference2, difference2, difference2);
	//(difference2 * (_TopColor.rgb *2)  + (1-difference2)) * baseColor.rgb * _Color.rgb;
